...
<input type="file" name="insideimage" multiple>
</div>
<div class="file-path-wrapper">
<input class="file-path validate" type="text" placeholder="Upload one or more files" value='<?php echo set_value('insideimage');?>'>
</div>
</div>
</div>
<div class="row">
